...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "Photoshop", bg: "#31A8FF", color: "#FFFFFF", icon: "Ps", iconBg: "#0369A1", iconColor: "#FFFFFF" },
      { name: "Illustrator", bg: "#FF9A00", color: "#FFFFFF", icon: "Ai", iconBg: "#7C2D12", iconColor: "#FFFFFF" },
      { name: "Webflow", bg: "#146EF5", color: "#FFFFFF", icon: "W", iconBg: "#1E40AF", iconColor: "#FFFFFF" },
      { name: "Miro", bg: "#FFD02F", color: "#FFFFFF", icon: "M", iconBg: "#713F12", iconColor: "#FFFFFF" },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Heuristic Audit", bg: "#F59E0B", color: "#FFFFFF", icon: <AssignmentRoundedIcon style={{ fontSize: 13, color: "#FFFFFF" }} />, iconBg: "#78350F", iconColor: "#FFFFFF" },
      { name: "WCAG 2.1 AA", bg: "#06B6D4", color: "#FFFFFF", icon: <AccessibleRoundedIcon style={{ fontSize: 13, color: "#FFFFFF" }} />, iconBg: "#164E63", iconColor: "#FFFFFF" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "JavaScript", bg: "#F7DF1E", color: "#FFFFFF", icon: "JS", iconBg: "#713F12", iconColor: "#FFFFFF" },
      { name: "React", bg: "#61DAFB", color: "#FFFFFF", icon: "⚛", iconBg: "#0C4A6E", iconColor: "#FFFFFF" },
      ...
      { name: "Tailwind CSS", bg: "#38BDF8", color: "#FFFFFF", icon: "≈", iconBg: "#0C4A6E", iconColor: "#FFFFFF" },
    ],
  },
  {
