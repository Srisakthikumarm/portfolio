...
import "../styles/InteractiveSocialBar.css";
...
const InteractiveSocialBar = ({ isHero = false }) => {
  ...
  return (
    <div className={`interactive-social-bar ${expanded ? "is-expanded" : ""} ${isHero ? "hero-variant" : ""}`}>
      {/* Initial Box 1: Primary Email */}
      <a
        href="mailto:srisakthikumar03@gmail.com"
        title="Email: srisakthikumar03@gmail.com"
      ...
      {/* Initial Box 2: Primary Behance Portfolio */}
      <a
      ...
      {/* Initial Box 3: MORE Toggle Box (180deg Hover Rotation, Click expands remaining profiles left-to-right) */}
      <button
        type="button"
        className="social-box-item more-toggle-btn"
        onClick={handleToggle}
        title={expanded ? "Collapse Profiles" : "More Profiles"}
      >
        <span className="retro-icon-frame black more-icon-frame">
          <span className="more-rotator-wrap">
            {expanded ? (
              <CloseRoundedIcon style={{ fontSize: 13, color: "#FFFFFF" }} />
            ) : (
              <AddRoundedIcon style={{ fontSize: 13, color: "#FFFFFF" }} />
            )}
          </span>
        </span>
      </button>

      {/* Extra Boxes Wrapper: Slides Out Smoothly Left-to-Right */}
      <div className="extra-social-boxes-wrap">
        <a
          href="https://dribbble.com/srisakthikumar"
          target="_blank"
          rel="noopener noreferrer"
          title="Dribbble Portfolio"
          className="social-box-item extra-box item-1"
          onClick={() => playFunnyClickSound()}
        >
        ...
        <a
          href="https://medium.com/@srisakthikumar03"
          target="_blank"
          rel="noopener noreferrer"
          title="Medium Case Studies"
          className="social-box-item extra-box item-2"
          onClick={() => playFunnyClickSound()}
        >
        ...
        <a
          ...
          className="social-box-item extra-box item-3"
          onClick={() => playFunnyClickSound()}
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          title="Live Framer Portfolio"
          className="social-box-item extra-box item-4"
          onClick={() => playFunnyClickSound()}
        >
...
export default InteractiveSocialBar;
